        ...
        <div class="row align-items-center">
            ...
            <div class="col-auto">
                <a class="btn btn-primary add-btn" href="#">
                    <i class="fa fa-plus fa-sm"></i> Add Banner
                </a>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title f-w-600" id="examLabel">Home Banner</h5>
                    <button class="close close-btn" type="button" data-dismiss="modal" aria-label="Close"><span
                            aria-hidden="true">×</span></button>
                </div>
                <form class="global-submission needs-validation" id="banner_creation" method="post"
                    action="{{ url('/portal/banner/store') }}" data-type="add" data-success="Banner Successfully Updated">
                    <div class="modal-body">
                        <div class="form">
                            <div class="form-group">
                                <label for="validationCustom03" class="mb-1"><span>*</span> Banner Title :</label>
                                <input class="form-control" name="banner_title" type="text" required>
                            </div>
                            <div class="form-group">
                                <label for="validationCustom03" class="mb-1">Banner Image :</label>
                                <input class="form-control" name="banner_img" accept="image/*" type="file">
                            </div>
                            <div class="form-group">
                                <label for="validationCustom01" class="mb-1"><span>*</span> Banner Description:</label>
                                <textarea name="banner_desc" type="textarea" class="form-control" rows="3"></textarea>
                            </div>
                            <div class="form-group">
                                <label for="validationCustom03" class="mb-1">Banner Button Text:</label>
                                <input class="form-control" name="banner_read_more" type="text">
                            </div>
                            <div class="form-group">
                                <label for="validationCustom03" class="mb-1">Banner Button Link :</label>
                                <input class="form-control" name="banner_read_more_link" type="text">
                            </div>
                            <div class="form-group">
                                <label for="validationCustom03" class="mb-1">Order No :</label>
                                <input class="form-control" name="banner_order" type="number">
                            </div>
                            <div class="form-group">
    ...
    <script>
        ...
        function dTSelection() {
            ...
            $('#dataTable tbody tr').on('click', '.fa-edit', function() {
                ...
                $("form#banner_creation .form-control,form#banner_creation input,form#banner_creation select")
                    .each(function(i) {
                ...
                $("#exam form").append("<input type='hidden' id='update_tmp_id' name='banner_id' value='" + data
                    .banner_id + "'>");
        ...
        window.dTtable = $("#dataTable").on('draw.dt', dTSelection).DataTable({
            destroy: true,
            "ajax": "{{ url('/portal/banner/getDtdata') }}",
            "columns": [{
                    "data": "banner_id",
                    "title": "action",
                    "render": function() {
                ...
                {
                    "data": "banner_read_more",
                    "title": "Read More",
                    "render": function(datum, row, data) {
                        console.log("Datum: ", datum);
                        var btn = "<a href='" + data.banner_read_more_link + "' target='_blank'><button class='dt_button'>" + datum +
                            "</button></a>";
                        return btn;
                    }
                },
