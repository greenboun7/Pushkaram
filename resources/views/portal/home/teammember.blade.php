        ...
        <div class="row align-items-center">
            ...
            <div class="col-auto">
                <a class="btn btn-primary add-btn" href="#">
                    <i class="fa fa-plus fa-sm"></i> Add Team Member
                </a>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title f-w-600" id="examLabel">Team Member</h5>
                ...
                <form class="global-submission needs-validation" id="team_creation" method="post"
                    action="{{ url('/portal/team/store') }}" data-type="add" data-success="Team Member Successfully Updated">
                    <div class="modal-body">
                        <div class="form">
                            <div class="form-group">
                                <label for="validationCustom03" class="mb-1"><span>*</span> Member Image :</label>
                                <input class="form-control" name="team_image" type="file" accept="image/*">
                            </div>
                            <div class="form-group">
                                <label for="validationCustom03" class="mb-1"><span>*</span> Member Name :</label>
                                <input class="form-control" name="team_name" type="text" required>
                            </div>
                            <div class="form-group">
                                <label for="validationCustom03" class="mb-1"><span>*</span> Member Designation :</label>
                                <input class="form-control" name="team_designation" type="text" required>
                            </div>
                            <div class="form-group">
                                <label for="validationCustom01" class="mb-1">Member Desc:</label>
                                <textarea name="team_desc" type="textarea" class="form-control" rows="3" *></textarea>
                            </div>
                            <div class="form-group">
...
@section('scripts')
    ...
    <script>
        $(".nav_team_member").addClass("active");
        ...
        function dTSelection() {
            ...
            $('#dataTable tbody tr').on('click', '.fa-edit', function() {
                ...
                $("#exam form").append("<input type='hidden' id='update_tmp_id' name='team_id' value='" + data
                    .team_id + "'>");
        ...
        window.dTtable = $("#dataTable").on('draw.dt', dTSelection).DataTable({
            destroy: true,
            "ajax": "{{ url('/portal/team/getDtdata') }}",
            "columns": [{
                    "data": "team_id",
                    "title": "action",
                    "render": function() {
