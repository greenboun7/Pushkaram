...
<div class="page-main-header">
    <div class="main-header-right row">
        <div class="main-header-left d-lg-none w-auto">
            <div class="logo-wrapper"><a href="{{url('/')}}/portal"><img class="blur-up lazyloaded"
                        src="{{ url('/') }}/assets/images/favicon.png" alt=""></a></div>
        </div>
        ...
        <div class="nav-right col">
            <ul class="nav-menus">
                ...
                <li><a class="text-dark" href="#!" onclick="javascript:toggleFullScreen()" id="full_screen"><i
                            data-feather="maximize-2"></i></a></li>

                <li class="onhover-dropdown">
                    <div class="media align-items-center"><img
                            class="align-self-center pull-right img-50 rounded-circle blur-up lazyloaded"
                            src="{{ url('/') }}/assets/images/favicon.png" style="box-shadow: 0px 0px 21px -8px black;" alt="header-user">
