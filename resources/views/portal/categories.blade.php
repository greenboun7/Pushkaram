        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title f-w-600" id="examLabel">Department</h5>
                ...
                <form class="global-submission needs-validation" id="category_creation" method="post"
                    action="{{ url('/portal/category/store') }}" data-type="add" data-success="Successfully Updated">
                    <div class="modal-body">
                        <div class="form">
                            <div class="form-group">
                                <label for="validationCustom03" class="mb-1"><span>*</span> Category Name :</label>
                                <input class="form-control" name="category_name" type="text" required>
                            </div>
                            <div class="form-group">
                                <label for="validationCustom01" class="mb-1"><span>*</span> Category type:</label>
                                <select class="form-control select" name="category_type" required>
                                    <option value="" selected default>Select Category type</option>
                                    <option value="event">Event</option>
                                    <option value="department">Department</option>
                                    <option value="page">Academic Page</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <label for="validationCustom03" class="mb-1">Category Description:</label>
                                <textarea name="category_desc" type="textarea" class="form-control" id="text_editor"
                                    cols="30" rows="10"></textarea>
                                {{-- <input class="form-control" name="portrait_image_url" type="file"> --}}
                            </div>
                            <div class="form-group">
                                <label for="validationCustom03" class="mb-1">Category Banner_image :</label>
                                <input class="form-control" name="category_banner_image" type="file">
                            </div>
                            <div class="form-group">
...
@section('scripts')
    ...
    <script>
        $("document").ready(function() {
            $(".horizontal-nav-menu a#blogs").addClass("active");

            editor1 = new RichTextEditor("#text_editor");
        });

        $(".nav_categories a").addClass("active");
        ...
        window.dTtable = $("#dataTable").on('draw.dt', dTSelection).DataTable({
            destroy: true,
            "ajax": "{{ url('/portal/category/getDtdata') }}",
            "columns": [{
                    "data": "category_id",
                    "title": "action",
                    "render": function() {
